...
class map(MapReduce_pb2_grpc.map):
    def reducer_inputs(self, request, context, **kwargs):
        ...
        print("location received by reducer 1: ", request.input)
...
with open("output_files/output1.txt", "w+") as file:
